...
deck_heroes( var_0, var_1 )
{
    ...
    if ( !common_scripts\utility::flag( "windows_got_company_line_before" ) )
    {
...
package_radiation()
{
    ...
    while ( !common_scripts\utility::flag( "escape_explosion" ) )
    {
        ...
        if ( var_2 < 150 && var_1 != "item_geigercouner_level2" )
        {
            var_0 stoploopsound();
        ...
        if ( var_1 != "item_geigercouner_level1" )
        {
            var_0 stoploopsound();
...
escape_seaknight()
{
    ...
    var_4 linkto( level.seaknight.model, "tag_detach" );
    level.seaknight.model thread maps\_anim::anim_loop_solo( var_4, "rescue", "tag_detach", "never_stop" );
    level.seaknight.model useanimtree(
    #animtree );
